  ...
  def create_information
	  ...
	  hash.each do |col1,arr1|
	  	...
	  	arr1.each do |product_type,ins|
	  		col2 = ApplicationHelper.get_product_type(product_type[0])
	  		ins.each do |id_rank,ins_rank|
	  			...
	  			elsif product_type[0] == 2 || product_type[0] == 4
	  				fee = 50
	  			elsif product_type[0] == 3
	  				fee = 200
	  			end
	  			col4 = "#{fee}万"
	  			col5,col6 = Rate.get_rate(product_type[0],id_rank[0],fee,age,man_income+woman_income)
	  		end
	  	end
	  end
